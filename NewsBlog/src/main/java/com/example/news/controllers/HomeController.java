...
public class HomeController {
	...
	private ConcurrentHashMap<String, User> users = new ConcurrentHashMap<>() {
		{
			put("vlad@vlad.com", new User("Vlad", "testpass", 20, "vlad@vlad.com", ""));
			put("ytka@ytka.ru", new User("Alexey Utkins", "testpass", 30, "ytka@ytka.ru",
					"https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcQqG2UN8kh8z6xn3BBKHS-MU9W0F1PEbU8qHzIJ2xS-jSq_BfRZ&usqp=CAU"));
		}
	};
